 ...
 * @author ductr
 */
public class CategoryProductGroup extends javax.swing.JPanel {

    /**
     * Creates new form CategoryProductGroup
     */
    public CategoryProductGroup() {
        initComponents();
        this.setName("productGroup");
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        m.selectPanel(new DetailsProductGroup());
        m.setVisible(true);
