 ...
 * @author ductr
 */
public class CategoryProductType extends javax.swing.JPanel {

    /**
     * Creates new form CategoryProductType
     */
    public CategoryProductType() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        m.selectPanel(new DetailsProductType());
        m.setVisible(true);
