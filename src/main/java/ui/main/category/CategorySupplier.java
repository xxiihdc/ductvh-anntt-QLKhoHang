...
import ui.dialog.SupplierDialog;
...
public class CategorySupplier extends javax.swing.JPanel {
    ...
    private void fillTable() {
        ...
        model.setRowCount(0);
        List<Supplier> lst = dao.selectAll();
        for (Supplier s : lst) {
            Object[] row = new Object[]{
                s.getName(),s.getAddress(),s.getPhone(),s.getEmail(),s.getSTK()
            };
            model.addRow(row);
        }
        lblRecord.setText("0/" + tblSupplier.getRowCount());
    }
}
