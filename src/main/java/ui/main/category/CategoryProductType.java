...
import ui.dialog.ProductTypeDialog;
...
public class CategoryProductType extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblProductType.setRowHeight(30);
        tblProductType.setRowMargin(5);
    ...
    private void fillTable() {
        ...
        model.setRowCount(0);
        List<ProductType> lst = dao.selectAll();
        for (ProductType s : lst) {
            Object[] row = new Object[]{
                s.getName(),s.getDescription()
            };
            model.addRow(row);
        }
        lblRecord.setText("0/" + tblProductType.getRowCount());
    }
}
